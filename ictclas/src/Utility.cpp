...
{
   char *cp= (char*)strstr(string,strCharSet);
...
int GetForeignCharCount(char *sWord)
{
  ...
  nForeignCount=GetCharCount((char*)TRANS_ENGLISH,sWord);//English char counnts
  nCount=GetCharCount((char*)TRANS_JAPANESE,sWord);//Japan char counnts
  if(nForeignCount<=nCount)
	nForeignCount=nCount;
  nCount=GetCharCount((char*)TRANS_RUSSIAN,sWord);//Russian char counnts
  if(nForeignCount<=nCount)
	nForeignCount=nCount;
...
int GetForeignType(char *sWord)
{
  ...
  nForeignCount=GetCharCount( (char*)(char*)TRANS_ENGLISH, sWord);//English char counnts
  nCount=GetCharCount( (char*)(char*)TRANS_RUSSIAN,sWord);//Russian char counnts
  if(nForeignCount<nCount)
  {
	  nForeignCount=nCount;
	  nType=TT_RUSSIAN;
  }
  nCount=GetCharCount( (char*)(char*)TRANS_JAPANESE,sWord);//Japan char counnts
  if(nForeignCount<nCount)
  {
	  nForeignCount=nCount;
	  nType=TT_JAPANESE;
